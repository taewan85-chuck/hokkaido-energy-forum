...
export const scenarios = [
  ...
  {
    id: 'package-rusutsu-0625',
    label: '6/25–6/28 루스츠 패키지',
    dateLabel: '6월 25일(목) ~ 6월 28일(일)',
    type: 'package',
    badge: '25일 출발 패키지',
    nights: 3,
    days: 4,
    ...
    packageUrl: 'https://www.onlinetour.co.kr/tour/w/goods/view?goodCode=OGJA17000032',
    baseDescription: '루스츠 리조트 3박4일 63홀 패키지 후보 / 항공 불포함 여부 확인 필요',
    summary: '6월 25일 출발 대안 패키지입니다. 3박4일 63홀 구성이 가능하나, 출발일별 가격과 잔여석은 상품 페이지에서 확인이 필요합니다.',
    inclusions: ['루스츠 리조트 3박 후보', '63홀 구성 후보', '온천/리조트 체류형', '상품 페이지에서 출발일별 가격 확인 필요'],
    exclusions: ['왕복 항공권 포함 여부 확인 필요', '중식/석식 일부', '개인 음료/주류', '캐디피/락커비/이용세 등 현장 추가비 가능성', '골프백 수하물', '출발일별 잔여석/티타임 확인 필요'],
  },
  {
